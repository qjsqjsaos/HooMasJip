package kr.loner.hoomasjip.sooyeolsample.presentation.widget.utils
...
/*
* 원치않는 이벤트가 일어나는 것을 방지하기 위함
* LiveData를 사용하다보면 View가 재활성화 될때
* 예를 들어 onStart나 onResume 상태로 재진입을 하게 되면 liveData가 observe를 호출 되면서
* 불필요한 observer event가 일어나는 것을 방지하기 위한 클래스이다.
* */
